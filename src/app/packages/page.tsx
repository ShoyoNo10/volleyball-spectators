      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <div className="text-xs text-gray-400">
            Live болон Replay үзэх эрх
          </div>
        </div>

        <div className="space-y-4">
          <PackageCard title="1 сар" price="10,000₮" onClick={() => buy(1)} loading={loading === 1} />
          <PackageCard title="6 сар" price="20,000₮" onClick={() => buy(6)} loading={loading === 6} highlight />
          <PackageCard title="1 жил" price="30,000₮" onClick={() => buy(12)} loading={loading === 12} />
        </div>
      </div>
...
function PackageCard({
  ...
  return (
    <div
      ...
      ${highlight ? "border border-cyan-400/50 bg-cyan-500/10" : "border border-white/10 bg-[#020617]"}`}
    >
      {highlight && (
